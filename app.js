...
function getListItem(index, places) {
    ...
    itemStr = '<img class="mapMarker" src="./map_marker.png">' +
                '<div class="info">' +
...
function addMarker(position, title) {
    ...
    var imageSrc = "./map_marker.png"
    imageSize = new kakao.maps.Size(36, 36),  // 마커 이미지의 크기
        imgOptions =  {
            // spriteSize : new kakao.maps.Size(36, 691), // 스프라이트 이미지의 크기
            // spriteOrigin : new kakao.maps.Point(0, (idx*46)+10), // 스프라이트 이미지 중 사용할 영역의 좌상단 좌표
            offset: new kakao.maps.Point(18, 36) // 마커 좌표에 일치시킬 이미지 내에서의 좌표
        },
...
// let clickCam = document.getElementById('nfc-tag');
// let showCam = document.getElementById('show-nfc');
// let defaultPage = document.getElementById('default');
// let k_map = document.getElementById('k_map');
